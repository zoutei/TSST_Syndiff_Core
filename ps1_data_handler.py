...
class ps1_data():
    ...
    def __init__(self, file, mask=False, catalog=None, toflux=True, pad=0, datapath=None):
        self.file = file 
        self.pad = pad
        self.ftype = 'log'   
        self.cat = None
    ...
    def _load_mask(self,mask):
        if mask:
            ...
            download_skycells([name],self.datapath,filters=[self.band],overwrite=False,mask=True)
